...
<tr><td> <em>Generated: </em> 2/8/2022 12:14:46 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-008-S22/m2-php-hw/grade/rat3" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/68829962/153037765-c53428b4-37cc-411c-817d-f80ea446be49.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>The screenshot for problem1.php working in dev environment<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>The way I solved the problem was that I basically traversed the array,<br>and use %2 on each of the values, and if it value was<br>1, then I basically echo the value. Since mod operator just gives the<br>remainder, and we know all the odd numbers have a remainder of 1<br>when divided by 2. <br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/68829962/153037956-e85f251c-8b92-425f-b569-4546a5d8c0a3.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>The screenshot for problem2.php working in dev environment<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>The way I solved this problem was that I declared a total variable,<br>then I traversed the inputted array and kept adding each of the value<br>inside the total variable. In the end I used a round function to<br>round to two decimal places, and number_format function to make sure all numbers<br>are rounded to zero. However, I realized it kept printing out string because<br>of the var_export function in the echo statement, so I basically removed that<br>function (workaround) and just printed it without it. I tried to multiply by<br>100, and divide by 100, and even casting it after the formatting, however<br>0.1 always showed 0.1 and never changed to 0.10. So, I just decided<br>to use this workaround. <br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/68829962/153038031-184fa55e-3082-4320-a6f3-eb32f0f49de9.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>The screenshot for problem3.php working in dev environment<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>The way I solved the problem was by iterating over the array, and<br>if the number in negative, I multiplied by -1 then echo, and if<br>not I just echo the number. There was no issues I faced with<br>this problem, only with problem 2. <br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://rat3-prod.herokuapp.com/M2/problem1.php">https://rat3-prod.herokuapp.com/M2/problem1.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://rat3-prod.herokuapp.com/M2/problem2.php">https://rat3-prod.herokuapp.com/M2/problem2.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://rat3-prod.herokuapp.com/M2/problem3.php">https://rat3-prod.herokuapp.com/M2/problem3.php</a> </td></tr>
<tr><td> <em>Sub-Task 4: </em> Pull Request URL for M2-PHP-HW to dev</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/rushitrivedi83/IT202-008/pull/4">https://github.com/rushitrivedi83/IT202-008/pull/4</a> </td></tr>
<tr><td> <em>Sub-Task 5: </em> Talk about what you learned, any issues you had, how you resolve them</td></tr>
<tr><td> <em>Response:</em> <p>One thing I learned was the numer_format function while trying to figure out<br>rounding, also while I was looking at the code, I noticed that we<br>can also add html tags in echo statement of php, and how the<br>structure was broken between html and php in the files. It was really<br>clean to see, since I didn&#39;t know you can break files like that<br>between php and html. So, regarding the issue with rounding, I tried many<br>ways I found on stackoverflow and g4g, and none of the way worked<br>since all they suggested was to use numer_format. So, in the end I<br>just edited the echo statement itself in order to submit it. <br></p><br></td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-008-S22/m2-php-hw/grade/rat3" target="_blank">Grading</a></td></tr></table>